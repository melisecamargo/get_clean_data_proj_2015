...
feature_file <- paste(uci_har_dir, "/features.txt", sep = "")
activity_labels_file <- paste(uci_har_dir, "/activity_labels.txt", sep = "")
x_train_file <- paste(uci_har_dir, "/train/X_train.txt", sep = "")
y_train_file <- paste(uci_har_dir, "/train/y_train.txt", sep = "")
subject_train_file <- paste(uci_har_dir, "/train/subject_train.txt", sep = "")
x_test_file <- paste(uci_har_dir, "/test/X_test.txt", sep = "")
y_test_file <- paste(uci_har_dir, "/test/y_test.txt", sep = "")
subject_test_file <- paste(uci_har_dir, "/test/subject_test.txt", sep = "")
...
tidyDataAVG = ddply(sensor_data_mean_std, c("Subject","Activity"), numcolwise(mean))
write.table(tidyDataAVG, file = "tidyDataAVG.txt", row.name = FALSE)
